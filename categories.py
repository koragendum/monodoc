# BLOCK       FLOW PHRAS BLOCK INLIN FORMAT
#             ---- ----- ----- ----- ------
# address      X     ·     X     ·     ·
# article      X     ·     X     ·     ·
# aside        X     ·     X     ·     ·
...
# tr           ·     ·     X     ·     ·
#             ---- ----- ----- ----- ------
# MATHML      FLOW PHRAS BLOCK INLIN FORMAT
#             ---- ----- ----- ----- ------
# math         X     X     ·     ·     ·
# mfrac        X     X     ·     ·     ·
# mi           X     X     ·     ·     ·
...
# munderover   X     X     ·     ·     ·
#             ---- ----- ----- ----- ------
# INLINE      FLOW PHRAS BLOCK INLIN FORMAT
#             ---- ----- ----- ----- ------
# a            X     X     ·     X     X
# abbr         X     X     ·     X     X
# b            X     X     ·     X     X
...
ELEMENTS = {
    ...
    'block-pre', 'block-code', 'block-indent', 'block-math', 'block-note',
    'block-quote', 'boxed-note', 'column-group', 'column-item', 'tab-group',
    'tab-item',
    # Extensions (phrasing)
